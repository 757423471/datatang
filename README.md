...
*Branch-win is for developing in windows platform. It doesn’t promise to provide a final or stable version, but offers a developer version to work in windows-based platform without modification.*
